...
Rails.application.configure do
  ...
  config.action_mailer.asset_host = 'http://sharebrain-rtr.herokuapp.com'
  ...
  # Mount Action Cable outside main_icon process or domain.
  ...
  # config.active_job.queue_name_prefix = "share_brain_production"
