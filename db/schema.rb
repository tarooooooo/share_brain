...
ActiveRecord::Schema.define(version: 2022_07_11_100000) do
  ...
  create_table "block_user_informations", charset: "utf8", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.integer "status", default: 0, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_block_user_informations_on_user_id", unique: true
  end
  ...
  add_foreign_key "block_user_informations", "users"
